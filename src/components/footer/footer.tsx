...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t-2 border-[#FF90E8] bg-black text-white mt-auto selection:bg-[#FF90E8] selection:text-black">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
              ...
              <form onSubmit={handleSubmit} className="mt-8 max-w-md">
                <div className="flex items-center rounded-sm border border-neutral-700/90 bg-black transition-colors focus-within:border-neutral-400">
                  ...
                  <button
                    ...
                    className="flex h-11 w-12 shrink-0 items-center justify-center bg-[#FF90E8] text-black font-semibold transition-all hover:bg-[#ff7be3] active:scale-95 disabled:opacity-75"
                  >
                    {status === "success" ? (
        ...
        <div className="mt-16 sm:mt-24 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2.5">
            <span className="flex size-5 items-center justify-center rounded-full bg-[#FF90E8] text-[11px] font-black text-black leading-none">
              G
            </span>
          ...
          <div className="flex items-center gap-7 sm:gap-9 text-white">
            ...
            <a
              ...
              className="text-white hover:text-[#FF90E8] transition-colors"
            >
